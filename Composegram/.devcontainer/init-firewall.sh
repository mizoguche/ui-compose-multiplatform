...
if ! curl --connect-timeout 5 https://dl.google.com/ >/dev/null 2>&1; then
    echo "ERROR: Firewall verification failed - unable to reach https://dl.google.com"
    exit 1
else
    echo "Firewall verification passed - able to reach https://dl.google.com as expected"
fi
